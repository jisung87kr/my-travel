    ...
    public function bookings(Request $request): View
    {
        ...
        $bookings->getCollection()->transform(function ($booking) use ($locale) {
            ...
            return [
                ...
                'product_image' => $booking->product->images->first()?->url ?? 'https://placehold.co/300x300?text=NO+IMAGE',
    ...
    public function reviews(): View
    {
        ...
        $reviews->getCollection()->transform(function ($review) use ($locale) {
            ...
            return [
                ...
                'product_image' => $product->images->first()?->url ?? 'https://placehold.co/300x300?text=NO+IMAGE',
