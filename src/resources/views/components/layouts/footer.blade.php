                ...
                <div>
                    ...
                    <div class="mt-4">
                        <a href="{{ route('home') }}" class="inline-flex items-center space-x-2">
                            <svg class="w-6 h-6 text-pink-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <span class="text-lg font-bold text-pink-600">My Travel</span>
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-3">
                            <!-- Facebook -->
                            <a href="#"
                               class="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-100 text-gray-600 hover:bg-pink-600 hover:text-white transition-colors"
                               aria-label="Facebook">
