                    ...
                    <form action="{{ route('products.index', ['locale' => app()->getLocale()]) }}" method="GET"
                        ...
                        <div class="relative flex-1 min-w-0">
                            ...
                            <div x-show="showDestination"
                                 ...
                                 style="display: none;">
                                <x-search.destination-dropdown :regions="$headerRegions" :compact="true" />
                            </div>
                        </div>
                        ...
                        <div class="relative flex-1 min-w-0">
                            ...
                            <div x-show="showDate"
                                 ...
                                 style="display: none;">
                                <x-search.date-picker-dropdown :compact="true" />
                            </div>
                        </div>
                        ...
                        <div class="relative flex-shrink-0">
                            <button type="button"
                                ...
                                <span class="text-sm whitespace-nowrap" :class="totalGuests > 1 ? 'text-gray-900 font-medium' : 'text-gray-500'" x-text="totalGuests > 1 ? '{{ __('home.adults_label') }} ' + adults + (children > 0 ? ', {{ __('home.children_label') }} ' + children : '') : '{{ __('home.add_guests') }}'"></span>
                            </button>
                            <!-- Guests Dropdown -->
                            <div x-show="showGuests"
                                 ...
                                 style="display: none;">
                                <x-search.guests-dropdown :compact="true" />
                            </div>
                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 space-y-3">
            ...
            <a href="{{ route('blog.index') }}"
               class="flex items-center gap-3 px-4 py-3.5 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors">
                ...
                <span class="text-sm font-medium text-gray-900">블로그</span>
            </a>
