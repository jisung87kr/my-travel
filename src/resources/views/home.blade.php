<x-layouts.app title="한국의 특별한 순간을 만나다">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center max-w-4xl mx-auto mb-12">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 tracking-tight leading-tight mb-6">
                    특별한 여행을<br class="sm:hidden" />
                    <span class="text-pink-500">경험</span>하세요
                </h1>
                            ...
                            <div class="relative flex-1 group">
                                ...
                                <div x-show="showDestination"
                                    ...
                                    <div class="border-t border-slate-100 pt-2">
                                        <p class="px-3 py-1.5 text-xs font-medium text-slate-400">인기 여행지</p>
                                        @php
                                            $searchRegions = [
                                                ['name' => '서울', 'icon' => 'text-pink-500'],
                                                ['name' => '부산', 'icon' => 'text-blue-500'],
                                                ['name' => '제주', 'icon' => 'text-orange-500'],
                                                ['name' => '경기', 'icon' => 'text-emerald-500'],
                                                ['name' => '강원', 'icon' => 'text-violet-500'],
                                            ];
                                        @endphp
                            ...
                            <div class="relative md:w-[28%] group">
                                <button type="button"
                                    ...
                                    <div class="flex flex-col flex-1 min-w-0">
                                        ...
                                        <span class="text-sm font-medium truncate" :class="date ? 'text-slate-900' : 'text-slate-400'" x-text="date || '날짜 선택'"></span>
                                    </div>
                                </button>
                                <!-- Date Dropdown -->
                                <div x-show="showDate"
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-end justify-between mb-8">
                <div>
                    <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">이달의 추천</h2>
                    <p class="text-slate-500 mt-1">여행자들이 가장 만족한 프리미엄 경험</p>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center py-16 text-slate-400">
                        ...
                        <p class="text-slate-600 font-medium">등록된 상품이 없습니다</p>
                    </div>
                @endforelse
            </div>
    ...
    <section class="py-16 sm:py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-10">
                <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">인기 여행지</h2>
                <p class="text-slate-500 mt-2">대한민국 구석구석, 매력적인 도시들</p>
            </div>
                ...
                <a href="{{ route('products.index', ['locale' => app()->getLocale(), 'region' => $region['value']]) }}"
                   class="group relative aspect-[4/5] rounded-2xl overflow-hidden cursor-pointer">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4">
                        ...
                        <p class="text-white/70 text-sm">{{ $region['count'] }}개의 체험</p>
                    </div>
                </a>
                @endforeach
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-end justify-between mb-8">
                <div>
                    <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">
                        지금 가장 <span class="text-pink-500">HOT</span>한 체험
                    </h2>
                    <p class="text-slate-500 mt-1">여행자들이 지금 가장 많이 예약하는 베스트셀러</p>
                </div>
            </div>
            ...
            @else
                <div class="flex flex-col items-center justify-center py-16 text-slate-400">
                    ...
                    <p class="text-slate-600 font-medium">인기 상품이 없습니다</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Section Header -->
            <div class="text-center mb-10">
                <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">여행자들의 후기</h2>
                <p class="text-slate-500 mt-2">실제 여행자들의 생생한 이야기</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="text-slate-500">아직 등록된 후기가 없습니다</p>
                </div>
                @endforelse
            </div>
        </div>
