                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="meeting_point_detail" name="meeting_point_detail" rows="2"
                                      ...
                                      class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all resize-none @error('meeting_point_detail') border-red-500 bg-red-50 @enderror">{{ old('meeting_point_detail') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <textarea id="translations_ko_includes" name="translations[ko][includes]" rows="4"
                                      ...
                                      class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all resize-none @error('translations.ko.includes') border-red-500 bg-red-50 @enderror">{{ old('translations.ko.includes') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="translations_ko_excludes" name="translations[ko][excludes]" rows="4"
                                      placeholder="줄바꿈으로 구분하여 입력해주세요&#10;예: 항공권&#10;여행자 보험&#10;개인 경비"
                                      class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all resize-none @error('translations.ko.excludes') border-red-500 bg-red-50 @enderror">{{ old('translations.ko.excludes') }}</textarea>
