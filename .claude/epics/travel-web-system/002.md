...
- [ ] 모든 테이블 마이그레이션 파일 생성
- [ ] Eloquent 모델 생성 및 관계 정의
- [ ] 개발용 Factory 및 Seeder 작성
- [ ] `php artisan migrate:fresh --seed` 정상 동작
- [ ] 외래 키 제약 조건 정상 동작
...
- [ ] 모든 마이그레이션 파일 생성 완료
- [ ] `php artisan migrate:fresh` 오류 없이 실행
- [ ] 모든 Eloquent 모델 생성 완료
- [ ] 모델 관계 테스트 (tinker로 확인)
- [ ] Seeder 실행 후 샘플 데이터 확인
- [ ] ERD 문서 작성 (선택)