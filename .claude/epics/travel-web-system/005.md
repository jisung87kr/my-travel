...
- [ ] 예약 취소 (관광객/제공자)
- [ ] 실시간 재고 차감/복구
- [ ] 예약 상태 변경 (pending → confirmed → completed)
- [ ] 예약 목록 조회 (관광객/제공자별)
- [ ] 노쇼 처리 및 카운트 증가
...
- [ ] Task 002 완료 (Booking, ProductSchedule 모델)
- [ ] Task 003 완료 (인증)
- [ ] Task 004 완료 (Product 조회)
...
- [ ] 자동 확정 예약 생성 및 재고 차감 동작
- [ ] 승인 필요 예약 → 승인 → 확정 플로우 동작
- [ ] 예약 취소 시 재고 복구 확인
- [ ] 노쇼 처리 및 예약 제한 동작
- [ ] 동시 예약 시 재고 정합성 테스트
- [ ] Feature Test 작성 (BookingTest.php)
- [ ] Unit Test 작성 (BookingServiceTest.php, InventoryServiceTest.php)